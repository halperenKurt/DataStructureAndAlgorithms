public class Hospital {
    public static void main(String[] args){
        ...
        if(service_2.size() == 10)
            total_grade += 2;
        if(service_2.queue.getByPosition(0).getName() == "patient_21")
            total_grade += 3;
        if(service_2.queue.getByPosition(1).getName() == "patient_22")
            total_grade += 3;
        if(service_2.queue.getByPosition(2).getName() == "patient_23")
            total_grade += 3;
        if(service_2.queue.getByPosition(3).getName() == "patient_24")
            total_grade += 3;
        if(service_2.queue.getByPosition(4).getName() == "patient_25")
            total_grade += 3;
        if(service_2.queue.getByPosition(5).getName() == "patient_26")
            total_grade += 3;
        if(service_2.queue.getByPosition(6).getName() == "patient_27")
            total_grade += 3;
        if(service_2.queue.getByPosition(7).getName() == "patient_28")
            total_grade += 3;
        if(service_2.queue.getByPosition(8).getName() == "patient_29")
            total_grade += 3;
        if(service_2.queue.getByPosition(9).getName() == "patient_30")
            total_grade += 3;
        //****************************************************//
